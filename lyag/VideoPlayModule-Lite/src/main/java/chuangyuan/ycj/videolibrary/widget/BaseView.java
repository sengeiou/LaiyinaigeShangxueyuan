...
abstract class BaseView extends FrameLayout {
    ...
    /***水印,封面图占位,显示音频和亮度布图*/
    protected ImageView exoPlayWatermark, exoPreviewImage, exoPreviewBottomImage, videoAudioImg, videoBrightnessImg,mIvHeadest;
    /***显示音频和亮度*/
    ...
    private void intiView(boolean isPreviewImageTop) {
        ...
        mIvHeadest = playerView.findViewById(R.id.iv_headeset);
