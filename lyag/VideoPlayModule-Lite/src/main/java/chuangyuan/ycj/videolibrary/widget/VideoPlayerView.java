...
public final class VideoPlayerView extends BaseView {
    private TransferAudioListener listener;
    private OnPlayListener onPlayListener;
    private OnPauseListener onPauseListener;
    private ImageButton mExoPlay,mExoPause;
    /**
    ...
    private void intiClickView() {
        ...
        mIvHeadest.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                listener.transferAudio();
            }
        });

        mExoPlay = playerView.findViewById(R.id.exo_play);
        mExoPause = playerView.findViewById(R.id.exo_pause);
        if(mExoPlay != null){
            mExoPlay.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View view) {
        ...
        if(mExoPause != null){
            mExoPause.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View view) {
    ...
    public void setTransferAudioListener(TransferAudioListener listener) {
    ...
    public void setIvHeadesrHide(boolean isHide) {
        if(isHide){
            mIvHeadest.setVisibility(GONE);
        }else {
            mIvHeadest.setVisibility(VISIBLE);
        }
    }
