 ...
 */
package com.baselib.widget.sliding;
...
//		navLinearLayout.setVisibility(View.VISIBLE);
	...
	public void hideNavLayout(){
		navLinearLayout.setVisibility(View.GONE);
	}
	...
	public static Bitmap getBitmapFromSrc(String src) {
		Bitmap bit = null;
		try {
			bit = BitmapFactory.decodeStream(AbSlidingPlayView.class.getResourceAsStream(src));
		} catch (Exception e) {
			e.printStackTrace();
		}
		return bit;
