 ...
 */
public class TaskReferAdapter extends CommonAdapter<TaskReferModel> {
    private String task_id;

    public TaskReferAdapter(Context context, List<TaskReferModel> datas, String task_id) {
        super(context, R.layout.item_task_refer, datas);
