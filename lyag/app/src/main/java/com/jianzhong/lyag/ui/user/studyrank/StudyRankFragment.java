...
import com.jianzhong.lyag.adapter.StudyRankAdapter;
...
public class StudyRankFragment extends BaseRecyclerViewFragment {
    ...
    public static StudyRankFragment newInstance(String chart) {

        Bundle args = new Bundle();

        StudyRankFragment fragment = new StudyRankFragment();
    ...
    protected RecyclerView.Adapter getRecyclerViewAdapter() {
        mAdapter = new StudyRankAdapter(mContext, mList);
        return mAdapter;
    }
    ...
    private void getInteractRank(){
        ...
        HttpRequest.getInstance().post(HttpConfig.URL_BASE + HttpConfig.URL_AC_POINT_RANK, params, new HttpCallBack() {
            @Override
    ...
    private void notifyData() {
        ...
        if (data.getMy_rank() != null && data.getMy_rank().getInfo() != null) {
            ...
            mViewHolder.mTvRank.setText((CommonUtils.parseInt(data.getMy_rank().getRanking()) + 1) + "");
            ...
            mViewHolder.mTvCredit.setText(data.getMy_rank().getInfo().getSum_point());
        } else {
        ...
        mViewHolder.mLlItem.setOnClickListener(new View.OnClickListener() {
            @Override
