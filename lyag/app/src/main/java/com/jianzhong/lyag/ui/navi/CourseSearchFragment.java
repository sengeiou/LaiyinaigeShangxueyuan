 ...
 */
public class CourseSearchFragment extends BaseRecyclerViewFragment {
    ...
    public static CourseSearchFragment newInstance(String keyWord) {
    ...
    protected RecyclerView.Adapter getRecyclerViewAdapter() {
        mAdapter = new CourseSearchAdapter(mContext,mList);
        return mAdapter;
    }
    ...
    private void getSearchFindCourse(){
        Map<String,Object> params = new HashMap<>();
        params.put("key_word",keyWord);
        params.put("p",pageIndex+"");
        HttpRequest.getInstance().post(HttpConfig.URL_BASE + HttpConfig.URL_SERCH_FIND_COURSE, params, new HttpCallBack() {
            @Override
            public void onSuccess(String s) {
                ResultList<CourseListModel> resultList = GsonUtils.json2List(s,CourseListModel.class);
