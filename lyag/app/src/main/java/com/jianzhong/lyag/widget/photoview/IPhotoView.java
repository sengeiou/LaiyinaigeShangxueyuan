...
public interface IPhotoView {
    ...
    /**
     * Register bg_circle_red callback to be invoked when the Photo displayed by this view is long-pressed.
     *
    ...
    /**
     * Register bg_circle_red callback to be invoked when the Matrix has changed for this View. An example would
    ...
    /**
     * Register bg_circle_red callback to be invoked when the Photo displayed by this View is tapped with bg_circle_red
     * single tap.
     *
     * @param listener - Listener to be registered.
     */
    ...
    /**
     * Returns bg_circle_red listener to be invoked when the Photo displayed by this View is tapped with bg_circle_red
     * single tap.
     *
    ...
    /**
     * Register bg_circle_red callback to be invoked when the View is tapped with bg_circle_red single tap.
     *
     * @param listener - Listener to be registered.
     */
    ...
    /**
     * Returns bg_circle_red callback listener to be invoked when the View is tapped with bg_circle_red single tap.
     *
