...
import com.jianzhong.lyag.adapter.CourseCollectAdapter;
...
public class CourseFragment extends BaseRecyclerViewFragment {
    ...
    protected View initView(LayoutInflater inflater) {
        mRootView = inflater.inflate(R.layout.fragment_course, null);
        return mRootView;
    }

    @Override
    protected RecyclerView.Adapter getRecyclerViewAdapter() {
        mAdapter = new CourseCollectAdapter(mContext, mList,0);
        return mAdapter;
    }
    ...
    public void isEdit(String tag) {
        ...
        } else if (tag.equals(AppConstants.TAG_COURSE)) {
