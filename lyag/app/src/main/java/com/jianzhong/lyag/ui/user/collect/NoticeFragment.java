...
import com.jianzhong.lyag.adapter.NoticeCollectAdapter;
...
public class NoticeFragment extends BaseRecyclerViewFragment {
    ...
    private NoticeCollectAdapter mAdapter;
    ...
    public void isEdit(String tag) {
        ...
        } else if (tag.equals(AppConstants.TAG_NOTICE)) {
    ...
    protected RecyclerView.Adapter getRecyclerViewAdapter() {
        mAdapter = new NoticeCollectAdapter(mContext, mList,0);
        return mAdapter;
    }

    @Override
    protected View initView(LayoutInflater inflater) {
        mRootView = inflater.inflate(R.layout.fragment_notice, null);
        return mRootView;
    }
