 ...
 */
public class AudioAboutAdapter extends CommonAdapter<AudioDetailModel> {

    private OnAudioListener listener;

    public AudioAboutAdapter(Context context, List<AudioDetailModel> datas, OnAudioListener listener) {
