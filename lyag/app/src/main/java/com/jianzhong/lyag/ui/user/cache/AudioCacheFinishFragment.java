...
import com.jianzhong.lyag.adapter.AudioDownloadFinishAdapter;
 ...
 */
public class AudioCacheFinishFragment extends BaseFragment {
    ...
    private AudioDownloadFinishAdapter mAdapter;
    private List<DownloadInfo> mList = new ArrayList<>();
    public static AudioCacheFinishFragment newInstance() {
        Bundle args = new Bundle();
        AudioCacheFinishFragment fragment = new AudioCacheFinishFragment();
    ...
    protected void initData() {
        ...
        mAdapter = new AudioDownloadFinishAdapter(mContext,mList,0);
