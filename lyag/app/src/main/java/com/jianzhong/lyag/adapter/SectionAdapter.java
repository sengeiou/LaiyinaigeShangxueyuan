...
public class SectionAdapter extends CommonAdapter<SectionModel> {
    ...
    public SectionAdapter(Context context, List<SectionModel> datas, String cover, ExpertModel expertModel) {
    ...
    protected void convert(ViewHolder holder, final SectionModel item, final int position) {
        ...
        holder.setOnClickListener(R.id.iv_download, new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (BaseApplication.mDownloadManager.getDownloadInfo(item.getVideo_cdn_url()) != null) {
                    ToastUtils.show(mContext,"任务已经在下载列表中");
                    DownloadInfo mDownloadInfo = BaseApplication.mDownloadManager.getDownloadInfo(item.getVideo_cdn_url());
                    ...
                    info.setUrl(item.getVideo_cdn_url());
                    ...
                    if(expertModel != null){
                        info.setName(expertModel.getRealname());
                        info.setPost(expertModel.getPos_duty());
                    }
