 ...
 */
public class PostMajorFragment extends BaseRecyclerViewFragment {
    ...
    public static PostMajorFragment newInstance(int isFinished) {

        Bundle args = new Bundle();

        PostMajorFragment fragment = new PostMajorFragment();
