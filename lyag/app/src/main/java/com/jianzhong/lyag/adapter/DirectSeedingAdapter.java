...
public class DirectSeedingAdapter extends CommonAdapter<LiveModel> {
    public DirectSeedingAdapter(Context context,List<LiveModel> datas) {
    ...
    protected void convert(ViewHolder holder, final LiveModel item, int position) {
        ...
        holder.setText(R.id.tv_watch, item.getOnline_user_num()+"人在线观看");
