...
import com.jianzhong.lyag.adapter.LiveCollectAdapter;
...
public class LiveFragment extends BaseRecyclerViewFragment {
    ...
    private LiveCollectAdapter mAdapter;
    ...
    protected RecyclerView.Adapter getRecyclerViewAdapter() {
        mAdapter = new LiveCollectAdapter(mContext, mList, 0);
        return mAdapter;
    }
    ...
    private void getCollect() {
        ...
        params.put("asset_type", AppConstants.TAG_LIVE);
