...
public class ClassCacheFragment extends BaseFragment {
    ...
    public static ClassCacheFragment newInstance() {

        Bundle args = new Bundle();

        ClassCacheFragment fragment = new ClassCacheFragment();
    ...
    protected View initView(LayoutInflater inflater) {
        mRootView = inflater.inflate(R.layout.fragment_class_cache, null);
        return mRootView;
    }
    ...
    private void initViewPager() {
        ...
        mFragments.add(ClassCacheFinishFragment.newInstance());
        mFragments.add(ClassCacheNowFragment.newInstance());
        //ViewPager设置适配器
