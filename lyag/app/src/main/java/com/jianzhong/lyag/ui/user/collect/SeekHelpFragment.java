...
import com.jianzhong.lyag.adapter.HelpCollectAdapter;
...
public class SeekHelpFragment extends BaseRecyclerViewFragment {
    ...
    private HelpCollectAdapter mAdapter;
    ...
    public void isEdit(String tag) {
        ...
        } else if (tag.equals(AppConstants.TAG_HELP)) {
    ...
    protected RecyclerView.Adapter getRecyclerViewAdapter() {
        mAdapter = new HelpCollectAdapter(mContext, mList,0);
        return mAdapter;
    }
    ...
    private void getCollect() {
        ...
        params.put("asset_type", AppConstants.TAG_HELP);
