...
public class ClassCacheNowFragment extends BaseFragment {
    ...
    private LinkedList<DownloadInfo> mAllTask = new LinkedList<>();

    public static ClassCacheNowFragment newInstance() {

        Bundle args = new Bundle();
        ClassCacheNowFragment fragment = new ClassCacheNowFragment();
    ...
    protected void initData() {
        ...
        if (!ListUtils.isEmpty(mAllTaskCache)) {
            for (int i = 0; i < mAllTaskCache.size(); i++) {
                if (mAllTaskCache.get(i).getState() != DownloadManager.FINISH) {
                    ...
                    if (item.getType() == 1 && item.getMediaType() == 1) {
        ...
        mAdapter = new ClassDownloadAdapter();
...
//                Toast.makeText(mContext, "所有下载任务完成", Toast.LENGTH_SHORT).show();
    ...
    private class ClassDownloadAdapter extends BaseAdapter {
        @Override
        public int getCount() {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            ViewHolder holder;
            if (convertView == null) {
                convertView = View.inflate(mContext, R.layout.item_class_download, null);
            ...
            if (info != null) {
                ...
                holder.mTvClassExpert.setText(info.getName() + "/" + info.getPost());
                GlideUtils.load(holder.mIvClass, info.getImg_url());
            } else {
    ...
    private class ViewHolder implements View.OnClickListener {
        ...
        private TextView mTvClassExpert;
        ...
        public ViewHolder(View convertView) {
            ...
            mIvClass = convertView.findViewById(R.id.iv_class);
            mTvClassExpert = convertView.findViewById(R.id.tv_class_expert);
            mCbCheck = convertView.findViewById(R.id.cb_check);
        }
