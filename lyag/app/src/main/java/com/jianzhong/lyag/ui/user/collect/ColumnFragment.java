...
import com.jianzhong.lyag.adapter.ColumnCollectAdapter;
...
public class ColumnFragment extends BaseRecyclerViewFragment {
    ...
    private ColumnCollectAdapter mAdapter;
    ...
    protected RecyclerView.Adapter getRecyclerViewAdapter() {
        mAdapter = new ColumnCollectAdapter(mContext, mList, 0);
        return mAdapter;
    }
    ...
    private void getCollect() {
        ...
        params.put("asset_type", AppConstants.TAG_COLUMN);
