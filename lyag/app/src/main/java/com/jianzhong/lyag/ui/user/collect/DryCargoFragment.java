...
import com.jianzhong.lyag.adapter.DryCargoCollectAdapter;
...
public class DryCargoFragment extends BaseRecyclerViewFragment {
    ...
    private DryCargoCollectAdapter mAdapter;
    private int pageIndex = 1;

    public static DryCargoFragment newInstance() {
    ...
    protected RecyclerView.Adapter getRecyclerViewAdapter() {
        mAdapter = new DryCargoCollectAdapter(mContext, mList,0);
        return mAdapter;
    }

    @Override
    protected View initView(LayoutInflater inflater) {
        mRootView = inflater.inflate(R.layout.fragment_collect_drycargo, null);
        return mRootView;
    }
    ...
    private void getCollect() {
        ...
        params.put("asset_type", AppConstants.TAG_AUDIO);
