package com.jianzhong.lyag.widget.pickerview;
...
public class TimeWheel {
    ...
    NumericWheelHoursAdapter mHourAdapter, mMinuteAdapter;
...
//        hour.setCurrentItem(mRepository.getDefaultCalendar().hour - minHour + 1);
//        hour.setCurrentItem(0);

        int curHour = getCurrentHour();
        int minMinute = mRepository.getMinMinute(curYear, curMonth, curDay, curHour + 1);
        int currentHour = mRepository.getDefaultCalendar().hour - minHour + 1;
        int currentMinute = mRepository.getDefaultCalendar().minute - minMinute + 1;
    ...
    void initMinute() {
        ...
        int curHour = getCurrentHour();
        int minMinute = mRepository.getMinMinute(curYear, curMonth, curDay, curHour + 1);
//        minute.setCurrentItem(mRepository.getDefaultCalendar().minute - minMinute + 1);
...
//        int maxHour = mRepository.getMaxHour(curYear, curMonth, curDay);
        ...
        mHourAdapter = new NumericWheelHoursAdapter(mContext, minHour, maxHour, PickerContants.FORMAT, mPickerConfig.mHour);
...
//        int maxMinute = mRepository.getMaxMinute(curYear, curMonth, curDay, curHour);
        ...
        mMinuteAdapter = new NumericWheelHoursAdapter(mContext, minMinute, maxMinute, PickerContants.FORMAT, mPickerConfig.mMinute);
