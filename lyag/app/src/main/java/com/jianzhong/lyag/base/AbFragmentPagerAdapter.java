...
public class AbFragmentPagerAdapter extends FragmentPagerAdapter {
	...
	/**
	 * Instantiates ImFriendModel new ab fragment pager adapter.
	 * @param mFragmentManager the m fragment manager
	 * @param fragmentList the fragment list
	 */
	public AbFragmentPagerAdapter(FragmentManager mFragmentManager, ArrayList<Fragment> fragmentList, String[] tabTitle) {
